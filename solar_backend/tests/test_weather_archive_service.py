...
class TestGetYearArchive:
    ...
    @patch("app.services.weather_archive_service.requests.get")
    def test_get_year_archive_different_locations(
        self, mock_get, mock_archive_response
    ):
    ...
    @patch("app.services.weather_archive_service.requests.get")
    def test_get_year_archive_dataframe_structure(
        self, mock_get, mock_archive_response
    ):
    ...
    @patch("app.services.weather_archive_service.requests.get")
    def test_get_year_archive_boundary_coordinates(
        self, mock_get, mock_archive_response
    ):
