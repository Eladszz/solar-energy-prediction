...
class TestGetWeatherForecast:
    ...
    def test_weather_api_fields(self):
        ...
        try:
            ...
            pytest.skip(
                "Live weather API is unavailable in the current test environment"
            )
        assert isinstance(data, dict), "Response should be a dictionary"
        assert "hourly" in data, "Response should contain 'hourly' key"
        hourly = data["hourly"]
        assert (
            "shortwave_radiation" in hourly
        ), "Hourly data should contain 'shortwave_radiation'"
    ...
    @patch("app.services.weather_service.requests.get")
    def test_get_weather_forecast_different_locations(
        self, mock_get, mock_weather_response
    ):
    ...
    @patch("app.services.weather_service.requests.get")
    def test_get_weather_forecast_boundary_latitude(
        self, mock_get, mock_weather_response
    ):
    ...
    @patch("app.services.weather_service.requests.get")
    def test_get_weather_forecast_boundary_longitude(
        self, mock_get, mock_weather_response
    ):
    ...
    @patch("app.services.weather_service.requests.get")
    def test_get_weather_forecast_radiation_values(
        self, mock_get, mock_weather_response
    ):
    ...
    @patch("app.services.weather_service.requests.get")
    def test_get_weather_forecast_temperature_values(
        self, mock_get, mock_weather_response
    ):
    ...
    @patch("app.services.weather_service.requests.get")
    def test_get_weather_forecast_decimal_precision(
        self, mock_get, mock_weather_response
    ):
